...
const Sidebar = () => {
  ...
  return (
    <div className="w-64 bg-white dark:bg-gray-700  shadow-md p-5 min-h-screen border-r">
    ...
    <li>
          ...
          >
           Workspace
            {open.workspace ? <ChevronDown size={18} /> : <ChevronRight size={18} />}
          </div>

          {open.workspace && (
            <ul className="ml-4 mt-2 space-y-2 text-gray-600 dark:text-gray-300">
              {menuItem("➕ Create Workspace", "/create-workspace")}
              {menuItem("📄 My Workspace", "/workspaces")}
              {menuItem("📄 Join Workspace", "/join-workspace")}
