  ...
  return (
    <div>
      ...
      <div className="flex">
        ...
        {/* Main Content */}
        <div className="flex-1 p-6 bg-orange-100 dark:bg-gray-500 min-h-screen">
          ...
          <div className="flex justify-between items-center mb-4 dark:text-white">
            <p className="text-lg font-semibold">
             ...
             <Link
                      to="/dashboard"
                      className="text-green-800 font-bold  px-4 py-2 rounded-lg  hover:text-green-600 transition dark:text-lime-300"
                    >
                      Home
                    </Link>
            <button
